...
export const campuses: Campus[] = [
  ...
  },
  {
    id: "ros",
    code: "ROS",
    name: "Roseland Collegiate",
    address: "10701 S Indiana Ave",
    lat: 41.6949,
    lon: -87.6188,
    students: 588,
    grades: "9-12",
...
export const morningStatuses: CampusStatus[] = [
  ...
  { campusCode: "LAW", status: "CLEAR", since: "07:10", detail: "No qualifying signals" },
  { campusCode: "WPK", status: "CLEAR", since: "07:10", detail: "No qualifying signals" },
  { campusCode: "ROS", status: "CLEAR", since: "07:10", detail: "No qualifying signals" },
